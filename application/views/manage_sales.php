	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="text-muted"><i class="fas fa-cog fa-spin"></i> Modify Sale Details</h4>
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="form-group">
								...
								<span class="helper-text text-left" data-original="Product Sold"></span>
							</div>
							<div class="form-group">
								<div class="input-group">
									<div class="input-group-prepend">
								...
								<span class="helper-text text-left" data-original="Quantity of Product Sold"></span>
							</div>
							<div class="form-group">
								<div class="input-group">
									<div class="input-group-prepend">
								...
								<span class="helper-text text-left" data-original="Cost of One Unit of Product"></span>
							</div>
							<div class="form-group">
								<div class="input-group">
									<div class="input-group-prepend">
								...
								<span class="helper-text text-left" data-original="Discount Allowed to Customer"></span>
							</div>
...
<div class="modal fade text-dark" id="print-details">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="text-muted"><i class="fas fa-print"></i> Print Sale Details</h4>
				<button class="close" data-dismiss="modal">&times;</button>
			</div>
