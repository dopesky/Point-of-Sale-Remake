<div class="row" ng-app="main" ng-cloak ng-controller="managePurchases" ng-init="currencyCode = '<?=$user_details->currency_code?>'">
	<main class="w-100 text-center col-12">
		<h2 class="header-text">Purchases <i class="fas fa-shopping-basket"></i></h2>
		<div class="box-shadow p-0 pt-0 container">
			...
			<div class="tab-content limit-tab-content-lower mb-3">
				<div class="tab-pane p-1 p-sm-3 active" id="view-products">
					<view-products url="<?=base_url('pointofsale/get_products_for_purchase')?>" type="purchase"></view-products>
				</div>
				<div class="tab-pane p-3 fade" id="shopping-cart">
					<view-cart type="purchase"></view-cart>
				</div>
				<?php if($this->session->userdata('userdata') !== null && (int)$this->session->userdata('userdata')['level'] > 1){?>
					<div class="tab-pane p-3 fade" id="manage-purchases">
						<?=$this->load->view('manage_purchases',array(),true)?>
					</div>
				<?php }?>
			</div>
		</div>
							...
							<div class="col-12">
								...
								<div class="form-group">
									<div class="input-group">
										...
										<input type="text" name="item3" ng-model="inputFields.item3" class="form-control" placeholder="Total Cost (after discount)">
									</div>
									<span class="helper-text text-left" data-original="Actual Amount Paid to Supplier e.g 24"></span>
								</div>
								<div class="form-group">
									<div class="input-group">
										<div class="input-group-prepend">
									...
									<span class="helper-text text-left" data-original="Discount Received e.g 11"></span>
								</div>
							...
							<div class="col-12">
								...
								<div class="form-group">
									<div class="input-group">
										...
										<input type="text" name="item2" ng-model="checkoutFields.item2" class="form-control" placeholder="Amount Paid" readonly>
									</div>
