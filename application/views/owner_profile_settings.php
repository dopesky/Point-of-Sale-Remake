<form method="post" class="text-center fade" autocomplete="off" enctype="multipart/form-data" ng-submit="updateDetails($event)">
	<div class="p-3 pt-0 pb-0">
		...
		<div class="form-group">
			<div class="input-group">
				...
				<input type="text" name="company" class="form-control" placeholder="Company Name" ng-model="user.company">
			</div>
		...
		<div class="form-group text-left">
			...
			<span class="helper-text" data-original="Your Company Logo Uniquely Identifies Your Company."></span>
		</div>
