...
class Api_key extends CI_Controller {
	...
	public function register(){
		...
		if ($this->form_validator->run_rules('api_sign_up')==false) {
	...
	public function get_api_keys(){
		...
		if (!isset($_POST['owner_id'])) {
			echo json_encode(array('ok'=>false,'errors'=>'<br><br><span>User ID is Required to Generate API Keys!</span>'));
			return false;
		}
	...
	public function update_api_key(){
		...
		if($database_response && isset($_POST['owner_id'])){
			return $this->get_api_keys();
		}else{
			echo json_encode(array('ok'=>false,'errors'=>'<br><br><span>An Unexpected Error Occurred!</span>'));
			return false;
