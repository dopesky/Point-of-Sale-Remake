<form method="post" class="text-center mt-5" autocomplete="off">
	<fieldset>
				...
				<div class="box-shadow ml-3 mr-3 p-3 pt-1">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="password" name="new_password" class="form-control" placeholder="New Password" value="<?=set_value('new_password')?>">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="password" name="repeat_password" class="form-control" placeholder="Repeat Password" value="<?=set_value('repeat_password')?>">
							<div class="input-group-append">
...
<script>
	var errors = `<?=$errors?>`
	if(errors){
		$('#page-errors>div.toast-body').html("<div><i class='fas fa-exclamation-circle'><i><strong> Errors: </strong>"+errors+"</div>").parent().toast({delay:5000}).toast('show')
	}
</script>